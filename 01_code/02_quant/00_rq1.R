...
for(subfile in rel_files){
  ...
  print(paste0("RQ1: ", extr_plat, " ", " DATE: ", extr_date, " - FINISHED AT ", Sys.time())) 
...
# Upload Data ----
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
print(paste0("RQ1: ", extr_plat, " - ", extr_date, " - EXPORT AT: ", Sys.time()))
...
write_parquet(out_data, paste0(out_rq1, extr_date, "/", extr_plat,"_rq1.parquet"))

print(paste0("RQ1: ", extr_plat, " - ", extr_date, " - EXPORT COMPLETE AT: ", Sys.time()))
